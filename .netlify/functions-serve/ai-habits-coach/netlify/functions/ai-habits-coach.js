...
// netlify/functions/ai-habits-coach.js
var ai_habits_coach_exports = {};
__export(ai_habits_coach_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(ai_habits_coach_exports);
...
${JSON.stringify(context || {})}`;
    const result = await withTimeout(
      2e4,
      (signal) => callOpenAI({ system, user, temperature: 0.35 }, signal)
    );
    return {
...
//# sourceMappingURL=ai-habits-coach.js.map
